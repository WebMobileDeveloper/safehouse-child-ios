...
class editProfileViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate,CountriesViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if user.photo_url != "" {
            ...
            if data != nil{
                ...
                image.image = #imageLiteral(resourceName: "editProfilePhotoGreyIcon")
            }
        }else{
            image.image = #imageLiteral(resourceName: "editProfilePhotoGreyIcon")
        }
    ...
    func changePassTapped() {
        if let viewController = UIStoryboard(name: "Map", bundle: nil).instantiateViewController(withIdentifier: "changePasswordViewController") as? changePasswordViewController {
    ...
    func deleteAccountTapped() {
        if let viewController = UIStoryboard(name: "Map", bundle: nil).instantiateViewController(withIdentifier: "deleteAccountViewController") as? deleteAccountViewController {
            if let navigator = self.navigationController {
                //viewController.childName = name
                navigator.pushViewController(viewController, animated: true)
            }
    ...
    @IBAction func btnSaveChangeTapped(_ sender: Any) {
